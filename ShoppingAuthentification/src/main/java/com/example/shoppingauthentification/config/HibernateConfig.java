package com.example.shoppingauthentification.config;
...
public class HibernateConfig {
    ...
    com.example.shoppingauthentification.config.HibernateProperty hibernateProperty;

    @Autowired
    public HibernateConfig(com.example.shoppingauthentification.config.HibernateProperty hibernateProperty) {
    ...
    protected LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.example.shoppingauthentification.entity");
